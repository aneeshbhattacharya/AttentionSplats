...
print("Loading Randomized attention")
...
class LocalTransformerOperations(nn.Module):
    ...
    def create_feature_as_transformer_input(self, gaussian_centres, gaussian_features):
        ...
        for idx, unique_voxel_position in enumerate(unique_voxels):
            ...
            # print("MATCHES:", matching_indices.tolist())
            matching_indices = random.sample(matching_indices.tolist(), int(len(matching_indices)*0.2)) # sample 20% of the features in the voxel for each round?
